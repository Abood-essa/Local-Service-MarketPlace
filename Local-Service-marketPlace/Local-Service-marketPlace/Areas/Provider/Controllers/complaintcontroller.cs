...
namespace Local_Service_marketPlace.Areas.Provider.Controllers
{
    ...
    public class ComplaintController : Controller
    {
        ...
        // GET: Provider/Complaint/Create?bookingId=X
        public async Task<IActionResult> Create(int bookingId)
        {
            ...
            var booking = await _db.Bookings
                ...
                .FirstOrDefaultAsync(b => b.Id == bookingId && b.ProviderProfileId == profile.Id);

            if (booking == null) return NotFound();

            // Only allow on active or completed bookings
            if (booking.BookingStatus == BookingStatus.Cancelled)
            {
                TempData["Error"] = "You cannot file a complaint on a cancelled booking.";
                return RedirectToAction("Details", "Booking", new { area = "Provider", id = bookingId });
            }
        ...
        // POST: Provider/Complaint/Create
        [HttpPost]
        ...
        // GET: Provider/Complaint/MyComplaints
